...
from website_elements_v3 import get_menu, get_menu_mobile, get_about, get_about_mobile, get_news, get_news_mobile, embbed_graph, embbed_graph_mobile, add_cases_compare, add_cases_compare_mobile
...
visitors_count = 270
visitors_count_desktop = 50
visitors_count_mobile = 8
